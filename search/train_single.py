...
parser.add_argument('--epochs', type=int, default=35, help='location of the data corpus')
...
parser.add_argument('--cutout_length', type=int, default=4, help='cutout length')
...
def main():
  ...
  utils.save(model, os.path.join(args.save, str(args.epochs)+'_weights.pt'))
